...
class AppColors {
  static Color primaryColor = const Color.fromRGBO(162, 62, 162, 1);
  ...
  static Color textColor = const Color.fromRGBO(210, 210, 210, 1);
...
ThemeData primaryTheme = ThemeData(
    ...
    floatingActionButtonTheme: FloatingActionButtonThemeData(
      ...
      shape: RoundedRectangleBorder(
        ...
        side: BorderSide(
          color: Colors.white.withOpacity(0.2), // Faint border color
